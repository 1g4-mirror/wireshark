...
extern wmem_map_t* keytab_file_longterm_keys;
extern wmem_map_t* keytab_file_all_keys;
extern wmem_map_t* keytab_file_session_keys;

/* TEMPORARY not static */
extern unsigned kerberos_longterm_ids;
