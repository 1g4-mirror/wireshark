...
/* Other RTP structures */
    ...
    vs_register_external_value_string_ext("rtp_payload_type_vals_ext", &rtp_payload_type_vals_ext);
    vs_register_external_value_string_ext("rtp_payload_type_short_vals_ext", &rtp_payload_type_short_vals_ext);
}
