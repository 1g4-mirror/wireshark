...
proto_register_btad_apple_ibeacon(void)
{
    static hf_register_info hf[] = {
        ...
        { &hf_btad_apple_nearbyaction_flags_authtag,
          { "Auth Tag Flag", "bluetooth.apple.nearybaction.flags.authtag",
        ...
        { &hf_btad_apple_nearbyinfo_unk_flag,
          { "Unkown Flag", "bluetooth.apple.nearbyinfo.unk.flag",
        ...
        { &hf_btad_apple_nearbyinfo_airpod_conn,
          { "AirPod Connecton Status", "bluetooth.apple.nearbyinfo.airpod.connection",
