...
/* TODO: Add units */
    ...
    vs_register_external_value_string("bthci_cmd_scan_enable_values", bthci_cmd_scan_enable_values);
    vs_register_external_value_string("bthci_cmd_encrypt_mode_vals", bthci_cmd_encrypt_mode_vals);
    vs_register_external_value_string("bthci_cmd_authentication_enable_values", bthci_cmd_authentication_enable_values);
    vs_register_external_value_string("bthci_cmd_inq_modes", bthci_cmd_inq_modes);
}
