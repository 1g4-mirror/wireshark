...
static dissector_table_t block_option_dissector_table;
    ...
    wtap_opttype_e option_type _U_, wtap_optval_t *optval, void *user_data)
{
	...
	default:
		dissector_try_uint_with_data(block_option_dissector_table,
...
proto_register_frame(void)
{
	...
	block_option_dissector_table = register_dissector_table("pcapng_block_option",
	    "PcapNG block option", proto_frame, FT_UINT32, BASE_DEC);
