...
static DNS_SVCB_PARAMS_COMMON_LIST_T(dissect_dhcpv6_dnr_svcb_params_hf);
              ...
              int off, int eoff, bool *at_end, int protocol, hopcount_info hpi, uint8_t msgtype)
{
    ...
    case OPTION_V6_DNR: {
        ...
        offset += dns_dissect_svcb_params(&dissect_dhcpv6_dnr_svcb_params_hf, tvb, pinfo, subtree, off + offset, off + optlen);
...
proto_register_dhcpv6(void)
{
    ...
    static hf_register_info hf[] = {
        ...
        DNS_SVCB_PARAMS_COMMON_HF_LIST(dissect_dhcpv6_dnr_svcb_params_hf, "dhcpv6.dnr"),
    };
    ...
    static int *ett[] = {
        ...
        DNS_SVCB_PARAMS_COMMON_ETT_LIST(dissect_dhcpv6_dnr_svcb_params_hf),
