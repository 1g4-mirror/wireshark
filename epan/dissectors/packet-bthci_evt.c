...
/* TODO: More detailed dissection */
    ...
    vs_register_external_value_string("bthci_evt_lmp_version", bthci_evt_lmp_version);
    vs_register_external_value_string("bthci_evt_hci_version", bthci_evt_hci_version);
}
