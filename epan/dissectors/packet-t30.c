...
proto_register_t30(void)
{
    ...
    vs_register_external_value_string_ext("t30_facsimile_control_field_vals_ext", &t30_facsimile_control_field_vals_ext);
    vs_register_external_value_string_ext("t30_facsimile_control_field_vals_short_ext", &t30_facsimile_control_field_vals_short_ext);
