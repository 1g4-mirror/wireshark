...
void proto_register_h225(void) {
  ...
  vs_register_external_value_string("T_h323_message_body_vals", T_h323_message_body_vals);
  vs_register_external_value_string("h225_ReleaseCompleteReason_vals", h225_ReleaseCompleteReason_vals);
  vs_register_external_value_string("FacilityReason_vals", FacilityReason_vals);
  vs_register_external_value_string("h225_RasMessage_vals", h225_RasMessage_vals);
  vs_register_external_value_string("GatekeeperRejectReason_vals", GatekeeperRejectReason_vals);
  vs_register_external_value_string("RegistrationRejectReason_vals", RegistrationRejectReason_vals);
  vs_register_external_value_string("UnregRequestReason_vals", UnregRequestReason_vals);
  vs_register_external_value_string("UnregRejectReason_vals", UnregRejectReason_vals);
  vs_register_external_value_string("AdmissionRejectReason_vals", AdmissionRejectReason_vals);
  vs_register_external_value_string("BandRejectReason_vals", BandRejectReason_vals);
  vs_register_external_value_string("LocationRejectReason_vals", LocationRejectReason_vals);
  vs_register_external_value_string("DisengageReason_vals", DisengageReason_vals);
  vs_register_external_value_string("DisengageRejectReason_vals", DisengageRejectReason_vals);
  vs_register_external_value_string("InfoRequestNakReason_vals", InfoRequestNakReason_vals);
}
