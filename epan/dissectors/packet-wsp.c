...
/* Required function calls to register the header fields and subtrees used  */
    ...
    vs_register_external_value_string_ext("wsp_vals_pdu_type_ext", &wsp_vals_pdu_type_ext);
    vs_register_external_value_string_ext("wsp_vals_status_ext", &wsp_vals_status_ext);
