...
void proto_register_tetra (void)
{
    ...
    { &hf_tetra_lengthIndicationOrCapacityRequest_01,
      { "lengthIndicationOrCapacityRequest", "tetra.lengthIndicationOrCapacityRequest_01",
    ...
    { &hf_tetra_lengthIndication_01,
      { "lengthIndication", "tetra.lengthIndication_01",
    ...
    { &hf_tetra_sub_type,
      { "sub-type", "tetra.sub_type",
        ...
        "INTEGER_0_1", HFILL }},
    { &hf_tetra_tm_sdu_02,
      { "tm-sdu", "tetra.tm_sdu_02",
        FT_BYTES, BASE_NONE, NULL, 0,
        "BIT_STRING_SIZE_264", HFILL }},
    { &hf_tetra_tm_sdu_03,
      { "tm-sdu", "tetra.tm_sdu_03",
        FT_BYTES, BASE_NONE, NULL, 0,
    ...
    { &hf_tetra_pdu_subtype,
      { "pdu-subtype", "tetra.pdu_subtype",
        ...
        "INTEGER_0_1", HFILL }},
    { &hf_tetra_tm_sdu_05,
      { "tm-sdu", "tetra.tm_sdu_05",
        FT_BYTES, BASE_NONE, NULL, 0,
        "BIT_STRING_SIZE_114", HFILL }},
    { &hf_tetra_lengthInd_ReservationReq_01,
      { "lengthInd-ReservationReq", "tetra.lengthInd_ReservationReq_01",
    ...
    { &hf_tetra_lengthIndication_02,
      { "lengthIndication", "tetra.lengthIndication_02",
    ...
    { &hf_tetra_frame_len_factor_01,
      { "frame-len-factor", "tetra.frame_len_factor_01",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_1", HFILL }},
    { &hf_tetra_timeslot_pointer_01,
      { "timeslot-pointer", "tetra.timeslot_pointer_01",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_15", HFILL }},
    ...
    { &hf_tetra_cell_number_01,
      { "cell-number", "tetra.cell_number_01",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_65535", HFILL }},
    { &hf_tetra_sdu,
      { "sdu", "tetra.sdu",
    ...
    { &hf_tetra_optional_elements_01,
      { "optional-elements", "tetra.optional_elements_01",
    ...
    { &hf_tetra_optional_elements_02,
      { "optional-elements", "tetra.optional_elements_02",
    ...
    { &hf_tetra_optional_elements_03,
      { "optional-elements", "tetra.optional_elements_03",
    ...
    { &hf_tetra_optional_elements_04,
      { "optional-elements", "tetra.optional_elements_04",
    ...
    { &hf_tetra_number_of_neighbour_cells_01,
      { "number-of-neighbour-cells", "tetra.number_of_neighbour_cells_01",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_7", HFILL }},
    ...
    { &hf_tetra_attach_detach_identifier_01,
      { "attach-detach-identifier", "tetra.attach_detach_identifier_01",
    ...
    { &hf_tetra_address_type_01,
      { "address-type", "tetra.address_type_01",
    ...
    { &hf_tetra_optional_elements_05,
      { "optional-elements", "tetra.optional_elements_05",
    ...
    { &hf_tetra_address_extension_01,
      { "address-extension", "tetra.address_extension_01",
        FT_BYTES, BASE_NONE, NULL, 0,
        "OCTET_STRING_SIZE_3", HFILL }},
    { &hf_tetra_subscriber_class_01,
      { "subscriber-class", "tetra.subscriber_class_01",
    ...
    { &hf_tetra_energy_saving_mode_01,
      { "energy-saving-mode", "tetra.energy_saving_mode_01",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_7", HFILL }},
    { &hf_tetra_scch_info,
    ...
    { &hf_tetra_group_identity_location_accept_01,
      { "group-identity-location-accept", "tetra.group_identity_location_accept_01",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_3", HFILL }},
    ...
    { &hf_tetra_group_predefined_lifetime_01,
      { "group-predefined-lifetime", "tetra.group_predefined_lifetime_01",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_3", HFILL }},
    ...
    { &hf_tetra_group_identity_downlink_01,
      { "group-identity-downlink", "tetra.group_identity_downlink_01",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_15", HFILL }},
    ...
    { &hf_tetra_proprietary_01,
      { "proprietary", "tetra.proprietary_01",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_7", HFILL }},
    ...
    { &hf_tetra_called_party_type_identifier_01,
      { "called-party-type-identifier", "tetra.called_party_type_identifier_01",
    ...
    { &hf_tetra_cipher_control_01,
      { "cipher-control", "tetra.cipher_control_01",
    ...
    { &hf_tetra_optional_elements_06,
      { "optional-elements", "tetra.optional_elements_06",
    ...
    { &hf_tetra_class_of_MS_01,
      { "class-of-MS", "tetra.class_of_MS_01",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_16777215", HFILL }},
    { &hf_tetra_energy_saving_mode_02,
      { "energy-saving-mode", "tetra.energy_saving_mode_02",
    ...
    { &hf_tetra_la_information_01,
      { "la-information", "tetra.la_information_01",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_16383", HFILL }},
    { &hf_tetra_ssi_04,
      { "ssi", "tetra.ssi_04",
    ...
    { &hf_tetra_group_identity_location_demand_01,
      { "group-identity-location-demand", "tetra.group_identity_location_demand_01",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_3", HFILL }},
    ...
    { &hf_tetra_group_report_response_01,
      { "group-report-response", "tetra.group_report_response_01",
        FT_BOOLEAN, BASE_NONE, NULL, 0,
        "BOOLEAN", HFILL }},
    ...
    { &hf_tetra_group_identity_uplink_01,
      { "group-identity-uplink", "tetra.group_identity_uplink_01",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_15", HFILL }},
    { &hf_tetra_proprietary_02,
      { "proprietary", "tetra.proprietary_02",
    ...
    { &hf_tetra_optional_elements_07,
      { "optional-elements", "tetra.optional_elements_07",
    ...
    { &hf_tetra_optional_elements_08,
      { "optional-elements", "tetra.optional_elements_08",
    ...
    { &hf_tetra_optional_elements_09,
      { "optional-elements", "tetra.optional_elements_09",
    ...
    { &hf_tetra_external_subscriber_number_01,
      { "external-subscriber-number", "tetra.external_subscriber_number_01",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_31", HFILL }},
    { &hf_tetra_prop,
      { "prop", "tetra.prop",
    ...
    { &hf_tetra_call_identifier_01,
      { "call-identifier", "tetra.call_identifier_01",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_1023", HFILL }},
    ...
    { &hf_tetra_optional_elements_10,
      { "optional-elements", "tetra.optional_elements_10",
    ...
    { &hf_tetra_basic_service_information_01,
      { "basic-service-information", "tetra.basic_service_information_01",
    ...
    { &hf_tetra_simplex_duplex_selection_01,
      { "simplex-duplex-selection", "tetra.simplex_duplex_selection_01",
    ...
    { &hf_tetra_optional_elements_11,
      { "optional-elements", "tetra.optional_elements_11",
    ...
    { &hf_tetra_basic_service_information_02,
      { "basic-service-information", "tetra.basic_service_information_02",
    ...
    { &hf_tetra_optional_elements_12,
      { "optional-elements", "tetra.optional_elements_12",
    ...
    { &hf_tetra_optional_elements_13,
      { "optional-elements", "tetra.optional_elements_13",
    ...
    { &hf_tetra_optional_elements_14,
      { "optional-elements", "tetra.optional_elements_14",
    ...
    { &hf_tetra_optional_elements_15,
      { "optional-elements", "tetra.optional_elements_15",
    ...
    { &hf_tetra_hook_method_selection_01,
      { "hook-method-selection", "tetra.hook_method_selection_01",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_1", HFILL }},
    { &hf_tetra_simplex_duplex_selection_02,
      { "simplex-duplex-selection", "tetra.simplex_duplex_selection_02",
    ...
    { &hf_tetra_optional_elements_16,
      { "optional-elements", "tetra.optional_elements_16",
    ...
    { &hf_tetra_calling_party_address_01,
      { "calling-party-address", "tetra.calling_party_address_01",
        FT_UINT32, BASE_DEC, VALS(tetra_Calling_party_address_type_vals), 0,
        "Calling_party_address_type", HFILL }},
    { &hf_tetra_external_subscriber_number_02,
      { "external-subscriber-number", "tetra.external_subscriber_number_02",
    ...
    { &hf_tetra_external_subscriber_number_03,
      { "external-subscriber-number", "tetra.external_subscriber_number_03",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_15", HFILL }},
    { &hf_tetra_prop_08,
      { "prop", "tetra.prop_08",
    ...
    { &hf_tetra_simplex_duplex_selection_03,
      { "simplex-duplex-selection", "tetra.simplex_duplex_selection_03",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_1", HFILL }},
    { &hf_tetra_optional_elements_17,
      { "optional-elements", "tetra.optional_elements_17",
    ...
    { &hf_tetra_basic_service_information_03,
      { "basic-service-information", "tetra.basic_service_information_03",
    ...
    { &hf_tetra_call_status_01,
      { "call-status", "tetra.call_status_01",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_7", HFILL }},
    ...
    { &hf_tetra_notification_indicator_01,
      { "notification-indicator", "tetra.notification_indicator_01",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_63", HFILL }},
    { &hf_tetra_prop_09,
      { "prop", "tetra.prop_09",
    ...
    { &hf_tetra_simplex_duplex_selection_04,
      { "simplex-duplex-selection", "tetra.simplex_duplex_selection_04",
    ...
    { &hf_tetra_optional_elements_18,
      { "optional-elements", "tetra.optional_elements_18",
    ...
    { &hf_tetra_notification_indicator_02,
      { "notification-indicator", "tetra.notification_indicator_02",
    ...
    { &hf_tetra_call_time_out_01,
      { "call-time-out", "tetra.call_time_out_01",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_31", HFILL }},
    { &hf_tetra_simplex_duplex_selection_05,
      { "simplex-duplex-selection", "tetra.simplex_duplex_selection_05",
    ...
    { &hf_tetra_optional_elements_19,
      { "optional-elements", "tetra.optional_elements_19",
    ...
    { &hf_tetra_call_priority_01,
      { "call-priority", "tetra.call_priority_01",
        FT_UINT32, BASE_DEC, VALS(tetra_T_call_priority_vals), 0,
        NULL, HFILL }},
    { &hf_tetra_basic_service_information_04,
      { "basic-service-information", "tetra.basic_service_information_04",
    ...
    { &hf_tetra_temporary_address_01,
      { "temporary-address", "tetra.temporary_address_01",
        FT_UINT32, BASE_DEC, VALS(tetra_Calling_party_address_type_vals), 0,
        "Calling_party_address_type", HFILL }},
    { &hf_tetra_notification_indicator_03,
      { "notification-indicator", "tetra.notification_indicator_03",
    ...
    { &hf_tetra_optional_elements_20,
      { "optional-elements", "tetra.optional_elements_20",
    ...
    { &hf_tetra_notification_indicator_04,
      { "notification-indicator", "tetra.notification_indicator_04",
    ...
    { &hf_tetra_optional_elements_21,
      { "optional-elements", "tetra.optional_elements_21",
    ...
    { &hf_tetra_notification_indicator_05,
      { "notification-indicator", "tetra.notification_indicator_05",
    ...
    { &hf_tetra_optional_elements_22,
      { "optional-elements", "tetra.optional_elements_22",
    ...
    { &hf_tetra_new_call_identifier_01,
      { "new-call-identifier", "tetra.new_call_identifier_01",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_1023", HFILL }},
    { &hf_tetra_call_time_out_02,
      { "call-time-out", "tetra.call_time_out_02",
        FT_UINT32, BASE_DEC, VALS(tetra_T_call_time_out_vals), 0,
        NULL, HFILL }},
    { &hf_tetra_call_time_out_03,
      { "call-time-out", "tetra.call_time_out_03",
        FT_UINT32, BASE_DEC, NULL, 0,
        "INTEGER_0_7", HFILL }},
    { &hf_tetra_call_status_02,
      { "call-status", "tetra.call_status_02",
    ...
    { &hf_tetra_notification_indicator_06,
      { "notification-indicator", "tetra.notification_indicator_06",
    ...
    { &hf_tetra_optional_elements_23,
      { "optional-elements", "tetra.optional_elements_23",
    ...
    { &hf_tetra_notification_indicator_07,
      { "notification-indicator", "tetra.notification_indicator_07",
    ...
    { &hf_tetra_optional_elements_24,
      { "optional-elements", "tetra.optional_elements_24",
    ...
    { &hf_tetra_optional_elements_25,
      { "optional-elements", "tetra.optional_elements_25",
    ...
    { &hf_tetra_simplex_duplex_selection_06,
      { "simplex-duplex-selection", "tetra.simplex_duplex_selection_06",
