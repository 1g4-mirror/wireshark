...
void
vs_register_external_value_string(const char* name, const value_string* vs)
{
...
void
vs_register_external_value_string_ext(const char* name, const value_string_ext* vse)
{
    g_hash_table_insert(registered_vs_ext, (void*)name, (void*)vse);
}

value_string_ext*
vs_get_external_value_string_ext(const char* name)
{
