...
struct packet_provider_funcs {
	...
	int32_t(*get_process_id)(struct packet_provider_data *prov, uint32_t dpeb_id, unsigned section_number);
	const char *(*get_process_name)(struct packet_provider_data *prov, uint32_t dpeb_id, unsigned section_number);
	const uint8_t *(*get_process_uuid)(struct packet_provider_data *prov, uint32_t dpeb_id, unsigned section_number, size_t *uuid_size);
};
...
WS_DLL_PUBLIC int32_t epan_get_process_id(const epan_t *session, uint32_t dpeb_id, unsigned section_number);

WS_DLL_PUBLIC const char *epan_get_process_name(const epan_t *session, uint32_t dpeb_id, unsigned section_number);

WS_DLL_PUBLIC const uint8_t *epan_get_process_uuid(const epan_t *session, uint32_t dpeb_id, unsigned section_number, size_t *uuid_size);
