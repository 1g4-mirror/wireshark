...
int32_t cap_file_provider_get_process_id(struct packet_provider_data *prov, uint32_t dpeb_id, unsigned section_number);
const char *cap_file_provider_get_process_name(struct packet_provider_data *prov, uint32_t dpeb_id, unsigned section_number);
const uint8_t *cap_file_provider_get_process_uuid(struct packet_provider_data *prov, uint32_t dpeb_id, unsigned section_number, size_t *uuid_size);
